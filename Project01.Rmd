...
##Example of what R can do. ( Sierra add excel and JMP graph - do not touch)
Include a very nicely made graph, very colorful, etc... 

Maybe compare it to a not-so nicely made graph? Show off the perks of utilizing R for data visualization.
...
#hypothesis creation, question asking
does obesity affect the ability to compelte arithmetic at a higher level?
-something along those lines

##Graphing + a Statistical test
