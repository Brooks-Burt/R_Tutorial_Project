...
Introduce what R is. Why it can be useful.

What our dataset is. The measure of ability in arithmetic in obese vs non-obese individuals.

##Getting Started
Before we can do anything with a data set in R we need to complete some initial setup maintenance: 
This includes 
##Load packages
...
One major benefit of R is that it's an "all-in-one" program, meaning once your data is uploaded you can complete all your tasks (data wrangling, editing, visualization, statistical analyses, and professional figures) within that program.
